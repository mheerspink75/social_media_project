...
public class TweetController {
     ...
     * Request: {content: 'string', credentials: 'Credentials'}
     * Response: 'Tweet'
     */
    @PostMapping
     ...
     * Instead, develop a way to keep track of "deleted" tweets so that even if a tweet is deleted, data with relationships to it (like replies and reposts) are still intact.
     * Request: 'Credentials'
     * Response: 'Tweet'
     */
    @DeleteMapping("/{id}")
     ...
     * transitive replies should. What that means is that if a reply to the target of the context is deleted, but there's another reply to the deleted reply,
